{ base16, options, nixosConfig, config, pkgs, lib, ... } @ args: with lib;
let
...
in {
  ...
  options.home = {
    ...
    shell.deprecationAliases = lib.mkOption {
  ...
  config = {
    ...
    home.shell = {
      ...
      functions = mkMerge [ {
        ...
        '';
      } (mapAttrs shellFunAlias config.home.shell.deprecationAliases) ];
