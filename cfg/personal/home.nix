...
in {
  ...
  config = {
    ...
    services.sshd.authorizedKeys = [
      ...
      "ecdsa-sha2-nistp256 AAAAE2VjZHNhLXNoYTItbmlzdHAyNTYAAAAIbmlzdHAyNTYAAABBBNuaPrQZZOXieACsYwJDyn+UB06xq9Fz1UaoEgFMybHKMJHU1SR98XsH071aJQc2gqkQ5QElUZ/BptUPj63xtDY= Termius Touch SE"
    ];
  };
}
