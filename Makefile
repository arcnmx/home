all: s31-000 s31-001 s31-002 s31-003 s31-004 swb1 fornuftig outdoor bedroom
...
fornuftig: build/fornuftig/firmware.elf
...
build/fornuftig/firmware.elf: $(DEPS_ESP8266_D1)
